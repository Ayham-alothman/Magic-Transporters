        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (docActivity == null) {
                        throw "the id of activity not found";
                    }
                    if (docMover.State != 'on-mission') {
                        throw "the mover curent not on-mission ";
                    }
                    if ((docActivity === null || docActivity === void 0 ? void 0 : docActivity.state) != 'on-mission') {
                        throw "the activity curent not on-mission ";
                    }
                    return [2 /*return*/];
                case 4:
                    e_1 = _a.sent();
...
exports.ValditionEndMission = ValditionEndMission;
